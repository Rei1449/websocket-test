...
const Home = () => {
  ...
  const createRoom = async() => {
    const res = await fetch("https://websocket-test-fa2gxhztza-an.a.run.app/create_room", {
      method: "POST",
      headers: {
  ...
  const entryRoom = async() => {
    const res = await fetch("https://websocket-test-fa2gxhztza-an.a.run.app/entry", {
      method: "POST",
      headers: {
				"Content-Type": "application/json",
			},
